                ...
                <section>
                    ...
                    <div className="content">
                        <div className="section">
                            ...
                            <p>- Giảm giá cho những khoá học mới khi đăng ký khoá học tại <a href="http://spacedev.vn/">website Spacedev</a>.</p>
                            ...
                            <p>- Quy đổi thành những dịch vụ khác có liên kết với Spacedev.</p>
                        </div>
                        <div className="section">
                            <h2>Học viên giới thiệu (học viên cũ):</h2>
                            <p>- Là học viên đã tham gia một hoặc nhiều khoá học tại Spacedev.</p>
                            ...
                            <p>- COIN có thể sử dụng để giảm giá cho những khoá học mới khi đăng ký khoá học tại website
                                <a href="http://spacedev.vn/">spacedev.vn</a>.</p>
                        ...
                        <div className="section">
                            ...
                            <p>- Là tài khoản học viên chưa tham gia bất kỳ khoá học nào của Spacedev.</p>
                            ...
                            <p>- Số tiền được giảm giá sẽ được hiển thị và được áp dụng khi đăng ký trực tuyến tại website
                                của
                                Spacedev qua link giới thiệu.</p>
                        </div>
                    </div>
                </section>
            </div>
